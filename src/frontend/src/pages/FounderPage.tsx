...
export function FounderPage() {
  return (
    <>
      <SEO
        title="Founder | Live Now Recovery — Building Recovery Infrastructure"
        description="The founder of Live Now Recovery is building a blockchain-powered recovery coordination platform to close the gaps in Ohio's MAT and harm reduction system."
        keywords="Live Now Recovery founder, opioid crisis personal story, MAT recovery technology, Ohio overdose platform founder, ICP blockchain recovery"
        canonical="/founder"
      />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Person",
            name: "Live Now Recovery Founder",
            jobTitle: "Platform Founder & Developer",
            description:
              "Built Live Now Recovery after personally experiencing the MAT access gap in Northeast Ohio. Recovery advocate and technology builder.",
            worksFor: {
              "@type": "Organization",
        ...
        <section className="bg-background py-16 px-4">
          <div className="max-w-2xl mx-auto">
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed">
                I searched for a MAT provider at 11pm on a Friday after a
                relapse. Every clinic I could find was closed. Every phone line
                rang out. The information existed — it just wasn't reachable.{" "}
                <strong className="text-foreground">
                  That's the gap Live Now Recovery closes.
                </strong>
              </p>
              <p className="text-muted-foreground leading-relaxed">
                Live Now Recovery is the platform I wish had existed when I
                needed it. It's not built on sympathy. It's built on systems —
                because sympathy doesn't answer the phone at 2am, but a
                real-time provider database does.
              </p>
              <p className="text-muted-foreground leading-relaxed">
          ...
          <div className="max-w-2xl mx-auto">
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed mb-8">
                ...
                death rate in the country. Kentucky. Tennessee. New Mexico.
                Rural Nevada. These are communities with willing providers,
            ...
            >
              <p className="text-muted-foreground leading-relaxed">
                Live Now Recovery is the infrastructure layer they're all
                missing.
              </p>
